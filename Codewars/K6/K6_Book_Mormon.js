...
function mormons(startingNumber, reach, target) { // super easy, and even though challenge requests it, i see no point in trying to make this recursive
    let count = 0
...
function Mormons(startingNumber, reach, target){ // for recursive version
