...
Object.create = function(prototype, properties = {}) { // ok.. so i got the first two lines of it on my own, then the rest of it i was kinda halfway there, but there were issues, tried to actually utilize both getPrototypeOf and setPrototypeOf, but most solns didnt bother with the former
