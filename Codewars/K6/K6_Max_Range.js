...
function maxSum(arr,range){ // easy enough, couldve used reduce from start, but seemed a little too messy
    const sums = range.map(e=>arr.slice(e[0],e[1]+1).reduce((a,b)=>a+b,0))
...
function maxSum(arr,range){ // 1-liner of my same method, neat
