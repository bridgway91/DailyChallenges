...
function isLanguageDiverse(list) { // easy enough
    const languages = [0,0,0] // Python, Ruby, JS
    for (let person of list) {
      if (person.language == 'Python') languages[0]++;
      if (person.language == 'Ruby') languages[1]++;
      if (person.language == 'JavaScript') languages[2]++;
    }
    languages.sort((a,b)=>a-b)
    return languages[2] <= 2*languages[0]
  }