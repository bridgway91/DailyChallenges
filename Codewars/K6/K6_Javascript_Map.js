...
Array.prototype.map = function (callback, context) { // so to start, ive heard it is very much NOT recommended to altar the base prototypes in javascript... so this whole challenge is a big no-no.. that said... I also didnt really understand it, this soln is from others
...
// gonna pass this challenge as just something to not worry about, if something similar comes up again hopefully ill start trying to figure it out properly