...
const React = require('react'); // okay, never dealt with React before, and this kata series is discontinued, so for a quick look it was simple enough, though very hand-holdy
