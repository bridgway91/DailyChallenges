...
class Shape { // had no idea how to start this so had to look at solns... thought at first there'd be something that allowed for multiple named constructors in the Shape class, but that's not allowed
    constructor(area) {
      this.area = area
    }
    valueOf() {return this.area}
  }
