...
function game(n) { // what a stupid game... also a bit embarassed how long it took me to figure out the math trick for this...
    const val = Math.pow(n,2) / 2
    return Number.isInteger(val) ? [val] : [val*2,2]
  }


// stupid problem not worthy of alternatives