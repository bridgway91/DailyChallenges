...
function generateU(n) { // took a min to figure out the relation, but then was simple, and brute-force method works for all tests
  const u = [0, 1, 1, 2]; // u[0] unused; u[1]=1, u[2]=1, u[3]=2
